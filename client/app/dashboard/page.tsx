              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-brand-gray-mid bg-brand-gray">
                    <th className="text-left px-6 py-3 text-xs font-semibold text-brand-gray-text uppercase tracking-wide">
                      Session Code
                    </th>
                    <th className="text-left px-6 py-3 text-xs font-semibold text-brand-gray-text uppercase tracking-wide hidden md:table-cell">
                      Started
                    </th>
                    <th className="text-left px-6 py-3 text-xs font-semibold text-brand-gray-text uppercase tracking-wide hidden md:table-cell">
                      Ended
                ...
                <tbody>
                  {pastSessions.map((s, i) => (
                    <tr
                      key={s.id}
                      className={`border-b border-brand-gray-mid/50 hover:bg-brand-gray/50 transition-colors ${i === pastSessions.length - 1 ? "border-0" : ""}`}
                    >
                      <td className="px-6 py-4 font-mono font-semibold text-brand-navy">
                        #{s.session_code}
                      </td>
                      <td className="px-6 py-4 text-brand-gray-text hidden md:table-cell">
